...
class Tsinghua_e2e(data.Dataset):
    ...
    def __init__(self, dataset_cfg=None,
                 phase=None, prefix='Tsinghua_crop', encoder=None):
...
def Tsinghua(num_parts=200, phase='train', encoder=None):
    cfg = Config()
    Mydata = Tsinghua_e2e(cfg.Data, phase=phase, prefix="Tsinghua_crop", encoder=encoder)
