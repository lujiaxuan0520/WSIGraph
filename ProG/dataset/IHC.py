...
class IHC_e2e(data.Dataset):
    ...
    def __init__(self, dataset_cfg=None,
                 phase=None, prefix='IHC_crop_new', encoder=None):
...
def IHC(num_parts=200, phase='train', encoder=None):
    cfg = Config()
    Mydata = IHC_e2e(cfg.Data, phase=phase, prefix="IHC_crop_new", encoder=encoder)
