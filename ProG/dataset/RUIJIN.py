...
class RUIJIN_e2e(data.Dataset):
    ...
    def __init__(self, dataset_cfg=None,
                 phase=None, prefix='RUIJIN_crop', encoder=None):
...
def RUIJIN(num_parts=200, phase='train', encoder=None):
    cfg = Config()
    Mydata = RUIJIN_e2e(cfg.Data, phase=phase, prefix="RUIJIN_crop", encoder=encoder)
