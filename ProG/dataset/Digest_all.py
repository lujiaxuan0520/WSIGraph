...
class Digest_all_e2e(data.Dataset):
    ...
    def __init__(self, dataset_cfg=None,
                 phase=None, prefix='Digest_ALL_crop_FFPE', encoder=None):
...
def Digest_all(num_parts=200, phase='train', encoder=None):
    cfg = Config()
    Mydata = Digest_all_e2e(cfg.Data, phase=phase, prefix="Digest_ALL_crop_FFPE", encoder=encoder)
