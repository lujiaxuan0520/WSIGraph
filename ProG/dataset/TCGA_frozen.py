...
class TCGA_frozen_e2e(data.Dataset):
    ...
    def __init__(self, dataset_cfg=None,
                 phase=None, prefix='TCGA_crop_FFPE', encoder=None):
...
def TCGA_frozen(num_parts=200, phase='train', encoder=None):
    cfg = Config()
    Mydata = TCGA_frozen_e2e(cfg.Data, phase=phase, prefix="TCGA_crop_Frozen", encoder=encoder)
